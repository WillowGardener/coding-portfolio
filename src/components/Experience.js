    ...
    return (
        <div className="experience component">
            <main>
                <div className="experience-item">
                    ...
                    <div className="experience-text">
                        ...
                        <p>
                            ...
                            Tasked with developing critical automation tools with python to maximize
                            efficiency of needed processes
                        </p>
                    </div>
                </div>
                ...
                <div className="experience-item education">
                    <img src="pdxcg.png" className="job-icon"/>
                    <div className="experience-text">
                        
                        <div className="experience-item-title"><div className="thick">PDX Code Guild </div></div>
                        <p className="italic">Graduated 2020</p>
                        <p>
                        Learned general programming with Python, front-end development with HTML, CSS, Javascript and Vue, and back-end development with Django and Django Rest Framework.
                        </p>
                    </div>
                </div>

                <div className="experience-item education">
                    <img src="trackers.png" className="job-icon"/>
                    <div className="experience-text">
                        
                        <div className="experience-item-title"><div className="thick">Trackers Earth </div> </div>
                        <p className="italic">Graduated 2014</p>
                        <p>
                        A year-long immersion course on edible and medicinal plants, wilderness survival, agroforestry, and outdoor education. 
                        </p>
                    </div>
                </div>

                <div className="experience-item education">
                    <img src="coa.png" className="job-icon"/>
                    <div className="experience-text">
                        
                        <div className="experience-item-title"><div className="thick">College of the Atlantic </div> </div>
                        <p className="italic">Graduated 2013</p>
                        <p>
                        An interdisciplinary program designed to combine fields of study in new ways. I focused on Psychology, Literature, and Anthropology and developed skills in systems analysis, multicultural social studies, and creative problem solving.
                        </p>
                    </div>
                </div>
