...
function Carousel() {
    ...
    const images = [
        ...
        {title: "Chat Hub", bgColor: "rgba(73, 11, 0, 0.849)", image: ChatHub, address:"http://hub.cyphernaut.net/", description: "A website where you can upload any image and get a randomly-generated image that will blend in with that picture, allowing you to dynamically create a pattern so that you can create highly-specialized camouflage that doesn't look like camouflage."}
    ]
